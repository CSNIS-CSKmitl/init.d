...
- เมื่อคำขอ `completed` และมี VMID/CTID กับ node จึงเห็นปุ่ม Start/Stop, Console และ SSH การกด Stop ส่ง graceful shutdown; ถ้าเครื่องไม่ตอบสนองให้ผู้ดูแลตรวจใน Proxmox
